...
M.set_item_affix = function(p)
	...
	for _, series in ipairs(affixSlotOptions(item, tableName == "suffixes" and "Suffix" or "Prefix", tableName, index)) do
		for _, optionId in ipairs(series.modIds) do
